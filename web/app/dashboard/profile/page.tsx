        ...
        {activeTab === 'github' && (
          <div className="bg-dark-card/80 rounded-lg shadow-sm p-6">
            <div className="text-center py-12">
              ...
              <button className="px-6 py-3 bg-gradient-to-r from-brand-primary to-brand-secondary text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-brand-primary/30 hover:-translate-y-0.5 transition-all duration-200">
